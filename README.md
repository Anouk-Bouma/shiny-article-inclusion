...
- Once you've prepared your data, you will be instructed to evaluate the articles
using the RUN_ME.qmd file
3. Open the RUN_ME.qmd file. Make sure your datafile is in your current working
directory, and change the name of the file in the RUN_ME file to the name of your
data file.
4. Run the RUN_ME file and evaluate your articles.
